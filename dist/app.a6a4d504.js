...
},{"./vue.common.dev.js":"node_modules/vue/dist/vue.common.dev.js"}],"C:/Users/hasee/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"C:/Users/hasee/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"C:/Users/hasee/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"node_modules/vue-hot-reload-api/dist/index.js":[function(require,module,exports) {
var Vue // late bind
var version
var map = Object.create(null)
...
exports.default = _default;
        var $482a2a = exports.default || module.exports;
      
      if (typeof $482a2a === 'function') {
        $482a2a = $482a2a.options;
      }
    
        /* template */
        Object.assign($482a2a, (function () {
          var render = function() {
  var _obj
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$482a2a', $482a2a);
          } else {
            api.reload('$482a2a', $482a2a);
          }
        }
...
},{"_css_loader":"C:/Users/hasee/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/icon.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $c2b291 = exports.default || module.exports;
      
      if (typeof $c2b291 === 'function') {
        $c2b291 = $c2b291.options;
      }
    
        /* template */
        Object.assign($c2b291, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "svg",
    { staticClass: "f-icon", attrs: { "aria-hidden": "true" } },
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$c2b291', $c2b291);
          } else {
            api.reload('$c2b291', $c2b291);
          }
        }
...
},{"_css_loader":"C:/Users/hasee/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"src/ButtonGroup.vue":[function(require,module,exports) {
"use strict";
  ...
  mounted: function mounted() {
    ...
    try {
      for (var _iterator = this.$el.children[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if (nodeName !== 'button') {
          console.warn("There should only f-button inside f-button-group, but you wrote ".concat(nodeName));
        }
      }
    } catch (err) {
...
exports.default = _default;
        var $263097 = exports.default || module.exports;
      
      if (typeof $263097 === 'function') {
        $263097 = $263097.options;
      }
    
        /* template */
        Object.assign($263097, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "f-button-group" }, [_vm._t("default")], 2)
}
var staticRenderFns = []
render._withStripped = true
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$263097', $263097);
          } else {
            api.reload('$263097', $263097);
          }
        }
...
},{"_css_loader":"C:/Users/hasee/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.common.js"}],"node_modules/assertion-error/index.js":[function(require,module,exports) {
/*!
 * assertion-error
...
},{"./lib/chai":"node_modules/chai/lib/chai.js"}],"node_modules/chai-spies/chai-spies.js":[function(require,module,exports) {
var define;
var global = arguments[3];
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function (obj) { return typeof obj; }; } else { _typeof = function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : function () {
  ...
  var spy = function (chai, _) {
    ...
    Sandbox.prototype.on = function (object, methodName, fn) {
      ...
      if (methodName in object && !isMethod) {
        throw new Error(['Unable to spy property "', methodName, '". Only methods and non-existing properties can be spied.'].join(''));
      }
    ...
    chai.spy = function (name, fn) {
      ...
      proxy.toString = function toString() {
        ...
        var s = "{ Spy";
        if (state.name) s += " '" + state.name + "'";
        if (l > 0) s += ", " + l + " call" + (l > 1 ? 's' : '');
        s += " }";
        return s + (fn !== noop ? "\n" + fn.toString() : '');
      };
    ...
    Assertion.addProperty('spy', function () {
      this.assert('undefined' !== typeof this._obj.__spy, 'expected ' + this._obj + ' to be a spy', 'expected ' + this._obj + ' to not be a spy');
      return this;
    });
    /**
     * # .called
    ...
    Assertion.addProperty('once', function () {
      new Assertion(this._obj).to.be.spy;
      this.assert(this._obj.__spy.calls.length === 1, 'expected ' + this._obj + ' to have been called once but got #{act}', 'expected ' + this._obj + ' to not have been called once', 1, this._obj.__spy.calls.length);
    });
    /**
     * # twice
     *
    ...
    Assertion.addProperty('twice', function () {
      new Assertion(this._obj).to.be.spy;
      this.assert(this._obj.__spy.calls.length === 2, 'expected ' + this._obj + ' to have been called twice but got #{act}', 'expected ' + this._obj + ' to not have been called twice', 2, this._obj.__spy.calls.length);
    });
    /**
    ...
    function assertWith() {
      ...
      if (always) {
        ...
        this.assert(passed === calls.length, 'expected ' + this._obj + ' to have been always called with #{exp} but got ' + passed + ' out of ' + calls.length, 'expected ' + this._obj + ' to have not always been called with #{exp}', expArgs);
      } else if (nthCall) {
        ...
        this.assert(nthCallWith(spy, nthCall - 1, expArgs), 'expected ' + this._obj + ' to have been called at the ' + ordinalNumber + ' time with #{exp} but got #{act}', 'expected ' + this._obj + ' to have not been called at the ' + ordinalNumber + ' time with #{exp}', expArgs, actArgs);
      } else {
        var passed = numberOfCallsWith(spy, expArgs);
        this.assert(passed > 0, 'expected ' + this._obj + ' to have been called with #{exp}', 'expected ' + this._obj + ' to have not been called with #{exp} but got ' + passed + ' times', expArgs);
      }
    }
    ...
    Assertion.addMethod('exactly', function () {
      ...
      if (always && _with) {
        ...
        this.assert(passed === calls.length, 'expected ' + this._obj + ' to have been always called with exactly #{exp} but got ' + passed + ' out of ' + calls.length, 'expected ' + this._obj + ' to have not always been called with exactly #{exp}', args);
      } else if (_with && nthCall) {
        var ordinalNumber = generateOrdinalNumber(nthCall),
            actArgs = calls[nthCall - 1];
        new Assertion(this._obj).to.be.have.been.called.min(nthCall);
        this.assert(_.eql(actArgs, args), 'expected ' + this._obj + ' to have been called at the ' + ordinalNumber + ' time with exactly #{exp} but got #{act}', 'expected ' + this._obj + ' to have not been called at the ' + ordinalNumber + ' time with exactly #{exp}', args, actArgs);
      } else if (_with) {
        passed = 0;
        calls.forEach(function (call) {
          if (call.length !== args.length) return;
        ...
        this.assert(passed > 0, 'expected ' + this._obj + ' to have been called with exactly #{exp}', 'expected ' + this._obj + ' to not have been called with exactly #{exp} but got ' + passed + ' times', args);
      } else {
        this.assert(this._obj.__spy.calls.length === args[0], 'expected ' + this._obj + ' to have been called #{exp} times but got #{act}', 'expected ' + this._obj + ' to not have been called #{exp} times', args[0], this._obj.__spy.calls.length);
      }
    });
    /**
     * # gt (n)
    ...
    function above(_super) {
      return function (n) {
        if ('undefined' !== typeof this._obj.__spy) {
          new Assertion(this._obj).to.be.spy;
          this.assert(this._obj.__spy.calls.length > n, 'expected ' + this._obj + ' to have been called more than #{exp} times but got #{act}', 'expected ' + this._obj + ' to have been called at most #{exp} times but got #{act}', n, this._obj.__spy.calls.length);
        } else {
          _super.apply(this, arguments);
        }
      };
    ...
    function below(_super) {
      return function (n) {
        if ('undefined' !== typeof this._obj.__spy) {
          new Assertion(this._obj).to.be.spy;
          this.assert(this._obj.__spy.calls.length < n, 'expected ' + this._obj + ' to have been called fewer than #{exp} times but got #{act}', 'expected ' + this._obj + ' to have been called at least #{exp} times but got #{act}', n, this._obj.__spy.calls.length);
        } else {
          _super.apply(this, arguments);
        }
      };
    ...
    function min(_super) {
      return function (n) {
        if ('undefined' !== typeof this._obj.__spy) {
          new Assertion(this._obj).to.be.spy;
          this.assert(this._obj.__spy.calls.length >= n, 'expected ' + this._obj + ' to have been called at least #{exp} times but got #{act}', 'expected ' + this._obj + ' to have been called fewer than #{exp} times but got #{act}', n, this._obj.__spy.calls.length);
        } else {
          _super.apply(this, arguments);
        }
      };
    ...
    function max(_super) {
      return function (n) {
        if ('undefined' !== typeof this._obj.__spy) {
          new Assertion(this._obj).to.be.spy;
          this.assert(this._obj.__spy.calls.length <= n, 'expected ' + this._obj + ' to have been called at most #{exp} times but got #{act}', 'expected ' + this._obj + ' to have been called more than #{exp} times but got #{act}', n, this._obj.__spy.calls.length);
        } else {
          _super.apply(this, arguments);
        }
      };
...
_vue.default.component('f-icon', _icon.default);

_vue.default.component('f-button', _button.default);

_vue.default.component('f-button-group', _ButtonGroup.default);
...
}
{
  ...
  var fButton = new _Constructor4({
    propsData: {
      icon: 'setting'
    }
  });
  fButton.$mount(); // 期望这个函数被执行, 这个匿名函数被间谍给监视了

  var spy = _chai.default.spy(function () {});

  fButton.$on('click', spy);
  var button = fButton.$el;
  button.click();
  expect(spy).to.have.been.called();
}
},{"vue":"node_modules/vue/dist/vue.common.js","./button":"src/button.vue","./icon":"src/icon.vue","./ButtonGroup":"src/ButtonGroup.vue","chai":"node_modules/chai/index.js","chai-spies":"node_modules/chai-spies/chai-spies.js"}],"C:/Users/hasee/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9534" + '/');
...
},{}]},{},["C:/Users/hasee/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/app.js"], null)
